...
function JsThree() {
    ...
    useEffect(() => {
        ...
        const renderer = new THREE.WebGLRenderer({ antialias: true, alpha: true });// alpha property to true when initializing the WebGLRenderer. This will make the background transparent.
    ...
    return (
        <>
            <div as="main" height="100vh" width="100vw" ref={mountRef}></div>  // Mounting point for Three.js scene.
        </>
    );
}

export default JsThree